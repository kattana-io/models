...
type PairSwap struct {
	...
	SqrtPriceX96 []byte `protobuf:"bytes,24,opt,name=SqrtPriceX96,proto3" json:"SqrtPriceX96,omitempty"`
	Liquidity    []byte `protobuf:"bytes,25,opt,name=Liquidity,proto3" json:"Liquidity,omitempty"`
	Tick         []byte `protobuf:"bytes,26,opt,name=Tick,proto3" json:"Tick,omitempty"`
}
...
func (x *PairSwap) GetSqrtPriceX96() []byte {
	if x != nil {
...
func (x *PairSwap) GetLiquidity() []byte {
	if x != nil {
		return x.Liquidity
	}
	return nil
...
var file_pairSwap_proto_rawDesc = []byte{
	...
	0x12, 0x06, 0x62, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x22, 0xc0, 0x05, 0x0a, 0x08, 0x50, 0x61, 0x69,
	...
	0x64, 0x54, 0x69, 0x6c, 0x6c, 0x12, 0x22, 0x0a, 0x0c, 0x53, 0x71, 0x72, 0x74, 0x50, 0x72, 0x69,
	0x63, 0x65, 0x58, 0x39, 0x36, 0x18, 0x18, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x53, 0x71, 0x72,
	0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x58, 0x39, 0x36, 0x12, 0x1c, 0x0a, 0x09, 0x4c, 0x69, 0x71,
	0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x18, 0x19, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x4c, 0x69,
	0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x54, 0x69, 0x63, 0x6b, 0x18,
	0x1a, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x54, 0x69, 0x63, 0x6b, 0x42, 0x12, 0x5a, 0x10, 0x2f,
	0x70, 0x6b, 0x67, 0x2d, 0x62, 0x69, 0x6e, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x62,
