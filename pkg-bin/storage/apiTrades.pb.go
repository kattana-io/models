...
type ApiTrade struct {
	...
	PriceA      float64 `protobuf:"fixed64,10,opt,name=PriceA,proto3" json:"PriceA,omitempty"`
	PriceAUSD   float64 `protobuf:"fixed64,11,opt,name=PriceAUSD,proto3" json:"PriceAUSD,omitempty"`
	PriceB      float64 `protobuf:"fixed64,12,opt,name=PriceB,proto3" json:"PriceB,omitempty"`
	PriceBUSD   float64 `protobuf:"fixed64,13,opt,name=PriceBUSD,proto3" json:"PriceBUSD,omitempty"`
	...
	ValueUsd    float64 `protobuf:"fixed64,17,opt,name=ValueUsd,proto3" json:"ValueUsd,omitempty"`
...
func (x *ApiTrade) GetPriceA() float64 {
	if x != nil {
		return x.PriceA
	}
	return 0
...
func (x *ApiTrade) GetPriceAUSD() float64 {
	if x != nil {
		return x.PriceAUSD
	}
	return 0
...
func (x *ApiTrade) GetPriceB() float64 {
	if x != nil {
		return x.PriceB
	}
	return 0
...
func (x *ApiTrade) GetPriceBUSD() float64 {
	if x != nil {
		return x.PriceBUSD
	}
	return 0
...
func (x *ApiTrade) GetValueUsd() float64 {
	if x != nil {
		return x.ValueUsd
	}
	return 0
...
var file_apiTrades_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x50, 0x72, 0x69, 0x63, 0x65, 0x41, 0x12, 0x1c,
	0x0a, 0x09, 0x50, 0x72, 0x69, 0x63, 0x65, 0x41, 0x55, 0x53, 0x44, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x01, 0x52, 0x09, 0x50, 0x72, 0x69, 0x63, 0x65, 0x41, 0x55, 0x53, 0x44, 0x12, 0x16, 0x0a, 0x06,
	0x50, 0x72, 0x69, 0x63, 0x65, 0x42, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x50, 0x72,
	0x69, 0x63, 0x65, 0x42, 0x12, 0x1c, 0x0a, 0x09, 0x50, 0x72, 0x69, 0x63, 0x65, 0x42, 0x55, 0x53,
	0x44, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x01, 0x52, 0x09, 0x50, 0x72, 0x69, 0x63, 0x65, 0x42, 0x55,
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x08, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x55, 0x73, 0x64, 0x12, 0x16,
...
var file_apiTrades_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_apiTrades_proto_goTypes = []interface{}{
	(*ApiTradesBlock)(nil), // 0: binary.ApiTradesBlock
	(*ApiTrade)(nil),       // 1: binary.ApiTrade
}
var file_apiTrades_proto_depIdxs = []int32{
	1, // 0: binary.ApiTradesBlock.Trades:type_name -> binary.ApiTrade
