...
type DirectSwap struct {
	...
	PriceA      float64   `ch:"pricea" json:"price_a"`
	PriceAUSD   float64   `ch:"pricea_usd" json:"price_a_usd"`
	PriceB      float64   `ch:"priceb" json:"price_b"`
	PriceBUSD   float64   `ch:"priceb_usd" json:"price_b_usd"`
	Wallet      string    `ch:"wallet" json:"wallet"`
	Order       uint16    `ch:"order" json:"order"`
	ValueUSD    float64   `ch:"value_usd" json:"value_usd"`
}
